...
@section('content')
    <!-- Navbar -->
    <nav id="navbar"
        class="fixed w-full z-50 transition-all duration-300 bg-gradient-to-b from-black/60 to-transparent py-4 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center">
                <!-- Logo -->
                <div class="flex items-center">
                    <a href="#" class="text-2xl font-bold tracking-wider flex items-center gap-3">
                        <img src="{{ asset('images/logoskycamp.png') }}" alt="LuhurCamp Logo"
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="#amenities"
                        class="hover:text-primary-300 transition-colors font-medium text-shadow-sm">Fasilitas</a>
                    <a href="#packages"
                        class="hover:text-primary-300 transition-colors font-medium text-shadow-sm">Paket</a>
                    <a href="#gallery"
                        class="hover:text-primary-300 transition-colors font-medium text-shadow-sm">Galeri</a>
                    <!-- Login Button -->
                    <a href="{{ route('login') }}"
                        class="px-6 py-2 bg-primary-600/90 hover:bg-primary-500 text-white rounded-full font-medium transition-all transform hover:scale-105 shadow-lg border border-primary-500/50 backdrop-blur-sm">
                        Masuk / Daftar
                    </a>
                </div>
        ...
        <!-- Mobile Menu -->
        <div id="mobile-menu"
            class="hidden md:hidden bg-secondary-900/95 backdrop-blur-md absolute w-full top-full left-0 border-t border-white/10 shadow-xl">
            <div class="px-4 pt-4 pb-6 space-y-2">
                ...
                <a href="{{ route('login') }}"
                    class="block px-4 py-3 text-center bg-primary-600 text-white rounded-lg mt-4 font-bold shadow-lg">Masuk
                    / Daftar</a>
            </div>
        </div>
    </nav>
    ...
    <section id="home" class="relative h-screen flex items-center justify-center overflow-hidden bg-gray-900">
        ...
        <div class="relative z-10 text-center px-4 max-w-5xl mx-auto">
            <div class="animate-fade-in-up">
                <span
                    class="inline-block py-1.5 px-4 rounded-full bg-white/10 backdrop-blur-md text-white text-sm font-semibold mb-6 border border-white/20 shadow-lg">
                ...
                <h1 class="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight tracking-tight text-shadow-lg">
                    ...
                    <span
                        class="text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-accent-300 filter drop-shadow-lg">Sentuhan
                        Modern</span>
                </h1>
                <p class="text-lg md:text-xl text-gray-100 mb-10 max-w-2xl mx-auto font-light text-shadow-md">
                    Rasakan sensasi berkemah di ketinggian 1400 MDPL dengan fasilitas lengkap, pemandangan awan, dan
                    pengalaman tak terlupakan.
                </p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="#packages"
                        class="px-8 py-4 bg-primary-600 hover:bg-primary-500 text-white text-lg rounded-full font-bold transition-all transform hover:scale-105 shadow-xl hover:shadow-primary-500/30 border border-primary-500/50">
                        Booking Sekarang
                    </a>
                    <a href="#about"
                        class="px-8 py-4 bg-white/10 hover:bg-white/20 backdrop-blur-md text-white text-lg rounded-full font-bold transition-all border border-white/30 shadow-lg hover:shadow-white/10">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-2 gap-16 items-center">
                <div class="relative group">
                    ...
                    <!-- Floating Card -->
                    <div
                        class="absolute -bottom-6 -right-6 bg-white p-6 rounded-xl shadow-xl max-w-xs animate-float hidden md:block border border-gray-100/50 backdrop-blur-sm bg-white/90">
                        <div class="flex items-center gap-4 mb-3">
                            <div
                                class="w-12 h-12 bg-primary-100 rounded-full flex items-center justify-center text-2xl shadow-inner">
                                🌤️</div>
                            <div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16">
                ...
                <p class="text-gray-600">Kami menyediakan berbagai fasilitas untuk memastikan pengalaman camping Anda tetap
                    nyaman, aman, dan menyenangkan.</p>
            </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
                ...
                @foreach($features as $feature)
                    <div
                        class="bg-white p-6 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 text-center group border border-gray-100">
                        <div
                            class="w-16 h-16 mx-auto {{ $feature['color'] }} rounded-2xl flex items-center justify-center text-3xl mb-4 group-hover:scale-110 group-hover:rotate-3 transition duration-300 shadow-inner">
                            {{ $feature['icon'] }}
                        </div>
                        <h3 class="font-bold text-gray-900 mb-1 group-hover:text-primary-600 transition">{{ $feature['title'] }}
                        </h3>
    ...
    <section id="packages" class="py-24 bg-white relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16">
                ...
                <p class="text-gray-600">Berbagai pilihan kavling dari yang minimalis hingga glamping mewah, sesuai
                    kebutuhan budget Anda.</p>
            </div>
    ...
    <section id="gallery" class="py-24 bg-secondary-900 text-white relative overflow-hidden">
        ...
        <div
            class="absolute top-0 left-0 w-64 h-64 bg-primary-500/10 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2">
        </div>
        <div
            class="absolute bottom-0 right-0 w-96 h-96 bg-accent-500/10 rounded-full blur-3xl translate-x-1/2 translate-y-1/2">
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="text-center mt-12">
                <a href="{{ route('admin.galeri.index') }}"
                    class="inline-flex items-center gap-2 text-primary-400 hover:text-primary-300 font-medium transition hover:translate-x-1">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                <div class="col-span-1 md:col-span-2 space-y-4">
                    <h3 class="text-2xl font-bold text-white flex items-center gap-3">
                        <img src="{{ asset('images/logoskycamp.png') }}"
                            class="h-10 w-auto filter grayscale opacity-80 hover:grayscale-0 hover:opacity-100 transition duration-300">
                        <span>LuhurCamp</span>
                    </h3>
                    <p class="text-gray-400 max-w-sm leading-relaxed">
                        ...
                        Anda dan keluarga di Puncak Dua.
                    </p>
                    <div class="flex space-x-4 pt-2">
                        <a href="#"
                            class="w-10 h-10 rounded-full bg-gray-900 border border-gray-800 flex items-center justify-center hover:bg-primary-600 hover:border-primary-600 hover:text-white text-gray-400 transition transform hover:-translate-y-1">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                            </svg>
                        </a>
                        <a href="#"
                            class="w-10 h-10 rounded-full bg-gray-900 border border-gray-800 flex items-center justify-center hover:bg-pink-600 hover:border-pink-600 hover:text-white text-gray-400 transition transform hover:-translate-y-1">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
                        ...
                        <a href="#"
                            class="w-10 h-10 rounded-full bg-gray-900 border border-gray-800 flex items-center justify-center hover:bg-blue-400 hover:border-blue-400 hover:text-white text-gray-400 transition transform hover:-translate-y-1">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-gray-400">
                        <li><a href="#home" class="hover:text-primary-500 transition flex items-center gap-2"><span
                                    class="w-1 h-1 bg-primary-500 rounded-full opacity-0 hover:opacity-100 transition"></span>
                                Beranda</a></li>
                        <li><a href="#about" class="hover:text-primary-500 transition flex items-center gap-2"><span
                                    class="w-1 h-1 bg-primary-500 rounded-full opacity-0 hover:opacity-100 transition"></span>
                                Tentang</a></li>
                        <li><a href="#packages" class="hover:text-primary-500 transition flex items-center gap-2"><span
                                    class="w-1 h-1 bg-primary-500 rounded-full opacity-0 hover:opacity-100 transition"></span>
                                Paket Camping</a></li>
                        <li><a href="#gallery" class="hover:text-primary-500 transition flex items-center gap-2"><span
                                    class="w-1 h-1 bg-primary-500 rounded-full opacity-0 hover:opacity-100 transition"></span>
                                Galeri</a></li>
                        <li><a href="{{ route('login') }}"
                                class="hover:text-primary-500 transition flex items-center gap-2"><span
                                    class="w-1 h-1 bg-primary-500 rounded-full opacity-0 hover:opacity-100 transition"></span>
                                Login Admin</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-5 text-sm text-gray-400">
                        <li class="flex items-start gap-3 group">
                            <div
                                class="mt-1 w-8 h-8 rounded-lg bg-gray-900 border border-gray-800 flex items-center justify-center group-hover:border-primary-600 transition">
                        ...
                        <li class="flex items-center gap-3 group">
                            <div
                                class="w-8 h-8 rounded-lg bg-gray-900 border border-gray-800 flex items-center justify-center group-hover:border-primary-600 transition">
                                <svg class="w-4 h-4 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <script>
            ...
            window.addEventListener('scroll', () => {
                if (window.scrollY > 20) {
                    navbar.classList.remove('bg-transparent', 'bg-gradient-to-b', 'from-black/60', 'to-transparent', 'py-4', 'text-white');
                    navbar.classList.add('bg-secondary-900/95', 'backdrop-blur-md', 'shadow-md', 'py-2', 'text-gray-100');
                } else {
                    navbar.classList.add('bg-transparent', 'bg-gradient-to-b', 'from-black/60', 'to-transparent', 'py-4', 'text-white');
                    navbar.classList.remove('bg-secondary-900/95', 'backdrop-blur-md', 'shadow-md', 'py-2', 'text-gray-100');
                }
            });
